        ...
        >
          ...
          <div className="min-w-0 lg:pr-6">
            ...
            <p
              ...
              "
            >
              Building modern digital experiences and technology
              solutions that help businesses grow, connect and move
              forward.
            </p>
            ...
            <div className="mt-2 flex items-center gap-1.5">
              ...
              <a
                ...
                className="
                  ...
                  focus-visible:border-[#FF0000]
                  focus-visible:bg-[#FF0000]
                  focus-visible:text-white
                  focus-visible:ring-2
                  focus-visible:ring-[#FF0000]/40
              ...
              <a
                ...
                className="
                  ...
                  focus-visible:border-[#1877F2]
                  focus-visible:bg-[#1877F2]
                  focus-visible:text-white
                  focus-visible:ring-2
              ...
              <a
                ...
                className="
                  ...
                  focus-visible:border-[#DD2A7B]
                  focus-visible:bg-[#DD2A7B]
                  focus-visible:text-white
                  focus-visible:ring-2
                  focus-visible:ring-[#DD2A7B]/40
                  focus-visible:ring-offset-2
                  focus-visible:ring-offset-[#071426]
              ...
              <a
                ...
                className="
                  ...
                  focus-visible:border-[#25F4EE]
                  focus-visible:bg-[#25F4EE]
                  focus-visible:text-white
                  focus-visible:ring-2
                  focus-visible:ring-[#25F4EE]/40
                  focus-visible:ring-offset-2
                  focus-visible:ring-offset-[#071426]
