    ...
    >
      ...
      {!isCenter && (
        <div className="absolute inset-x-0 bottom-0 flex justify-center pb-5">
          <span className="text-[8px] font-semibold uppercase tracking-[0.14em] text-white [writing-mode:vertical-rl]">
            {member.role}
          </span>
        </div>
      )}
      ...
      {isCenter && (
        ...
        >
          <p className="mb-1.5 text-[8px] font-semibold uppercase tracking-[0.16em] text-white/70">
            {member.role}
          </p>
          ...
          {member.description && (
            <p className="mt-1.5 max-w-sm text-[9px] leading-relaxed text-white/70 sm:text-[10px]">
              {member.description}
            </p>
          )}

          <p className="mt-3 text-[8px] font-medium uppercase tracking-[0.14em] text-white/50 transition-colors duration-300 group-hover:text-white/80">
            View profile ↗
          </p>
        </motion.div>
      )}
